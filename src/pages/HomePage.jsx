        ...
        <div className="container-max grid md:grid-cols-2 items-center gap-6">
          ...
          >
            ...
            <p className="text-sm md:text-base lg:text-lg text-slate-600 mb-6">
              {t.heroSubtitle ||
                "Découvrez nos compléments alimentaires premium pour une vie saine et équilibrée."}
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link to="/about">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto btn-outline text-sm"
                >
                  {t.learnMore}
                </Button>
              </Link>
      ...
      <section className="container-max">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl md:text-2xl font-semibold text-foreground">
            {t.featuredProducts || "Nos Meilleurs Produits"}
          </h2>
          <Link
            to="/shop"
      ...
      <section className="bg-slate-100 py-8 md:py-12">
        <div className="container-max">
          <h2 className="text-xl md:text-2xl font-semibold text-center text-foreground mb-8">
            {t.whyChooseUs || "Pourquoi Nous Choisir ?"}
          </h2>
      ...
      <section className="container-max text-center">
        <div className="bg-primary text-primary-foreground p-6 md:p-8 rounded-lg shadow-xl">
          <h2 className="text-xl md:text-2xl font-semibold mb-3">
            {t.ctaTitle || "Prêt à Booster Votre Bien-être ?"}
          </h2>
          <p className="text-sm md:text-base mb-4 mx-auto max-w-2xl">
            {t.ctaSubtitle ||
              "Parcourez notre catalogue complet et trouvez les compléments parfaits pour vous."}
          </p>
          <Link to="/shop">
            <Button
              size="lg"
              variant="outline"
              className="border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary text-sm"
            >
              {t.exploreShop}
            </Button>
          </Link>
